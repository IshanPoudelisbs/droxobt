...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    const embed1 = new MessageEmbed()
      ...
      .setDescription(
        `DROX is a powerful multi-purpose Discord bot with features like moderation, fun commands, customizable messages, and advanced polls, making server management easy and engaging.`,
      )
      .addField(
        "<:ArrowRight:1286701004464721950> __Commands__",
    ...
    const embed10 = new MessageEmbed()
      .setColor(client.color)
      .addField(`${emoji.id.games} Games Commands`, "`gay`, `slap`");
    ...
    async function generateEmbed() {
      ...
      embed.setFooter(
        `Thanks For Choosing DROX`,
        arypton.displayAvatarURL({ dynamic: false }),
      );
      return embed;
    }
