...
client.on('messageCreate', async (message) => {
  // Check if the message starts with the ?addlogo command
  if (message.content.startsWith('?addlogo')) {
      // Split the message content and get the URL
      ...
      try {
          ...
          const filePath = join(__dirname, 'temp.gif');
          ...
          message.reply('Bot logo updated successfully!');
      } catch (error) {
          console.error('Error updating bot logo:', error);
          message.reply('Failed to update bot logo. Make sure the GIF URL is valid and try again.');
      }
  }
});
